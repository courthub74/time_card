...
// window.onclick = function(event) {
//     // Test it out
//     console.log("Outside button Pressed");
//     // If the drop button is not clicked
//     if (!event.target.matches('.dropdown')) {
//         // Create a variable that stores the dropdown items list
//         let dropdowns = document.getElementsByClassName('.name_list');
//         let i;
//         for (i=0; i < dropdowns.length; i++) {
//             // store all the dropdowns in a var
//             let opendropdowns = dropdowns[i];
//             console.log(opendropdowns);
//             // if the dropdowns 'contain' show
